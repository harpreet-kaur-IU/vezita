...
export default function MyCalendar(){
  ...
  //time slots for days
  const [timesSlots,setTimesSlots] = useState([["1.00","1.15"],["1.40","2.00"],["5.30","5.50"]])
  const [arr,setArr] = useState([["1.00","1.15"],["1.40","2.00"],["4.20","4.30"],["5.30","5.50"]])
            ...
            <div className={`d-flex d-flex-wrap col-12 mt-2`}>
                ...
                {viewTab == "week" && <div className={`col-12 ${styles["week__calendar"]}`}>
                    <div className={`p-relative ${styles["week__header"]}`}>
                        ...
                        {/* Map this module */}
                        <WeekDay type="1" data={[1]} day={currentDay}></WeekDay>
                ...
                {viewTab == "day" && <div className={`col-12 ${styles["week__calendar"]}`}>
                    <div className="d-flex d-flex-wrap col-12 mr-2 p-relative">
                        ...
                        <div className="col-12">
                            ...
                            <WeekDay type="1" arraySlots = {arr} data={timesSlots} day={currentDay}></WeekDay> 
